...
<div class="options-panel">
    ...
    <div class="row no-gutter">
        ...
        <div class="control-item col-12 col-l-12 <?php if (is_rtl()) { echo 'rtl'; }?>">
            <div class="content-box">
                ...
                <div class="control-wraper">
                  ...
                  <!-- latest_code_news Control Item -->
        <div class="control-item col-12 col-l-12 <?php if (is_rtl()) { echo 'rtl'; }?>">
            <div class="content-box">
                <label for="latest_code">
                    <?php echo __('Last news','tornado'); ?>
                    <span class="ti-help-mark help-btn" data-txt="<?php echo __('this code will  before </body> closing tag','tornado'); ?>"></span>
                </label>
                <div class="control-wraper">
                    <textarea name="latest_code" class="ltr h120" id="codemirror-3"><?php echo esc_html__(get_option('latest_code')); ?></textarea>
                </div>
            </div>
        </div>
                         <!-- latest_code_news Control Item -->
        <div class="control-item col-12 col-l-12 <?php if (is_rtl()) { echo 'rtl'; }?>">
            <div class="content-box">
                <label for="profilio_advantage">
                    <?php echo __(' Page profilio advantage','tornado'); ?>
                    <span class="ti-help-mark help-btn" data-txt="<?php echo __('this code will  before </body> closing tag','tornado'); ?>"></span>
                </label>
                <div class="control-wraper">
                    <textarea name="profilio_advantage" class="ltr h120" id="codemirror-3"><?php echo esc_html__(get_option('profilio_advantage')); ?></textarea>
                </div>
            </div>
        </div>
       
               <!-- banner_code Control Item -->
        <div class="control-item col-12 col-l-12 <?php if (is_rtl()) { echo 'rtl'; }?>">
            <div class="content-box">
                <label for="banner_code">
                    <?php echo __('Bnner Code','tornado'); ?>
                    <span class="ti-help-mark help-btn" data-txt="<?php echo __('this code will be added before </body> closing tag','tornado'); ?>"></span>
                </label>
                <div class="control-wraper">
                    <textarea name="banner_code" class="ltr h120" id="codemirror-3"><?php echo esc_html__(get_option('banner_code')); ?></textarea>
                </div>
            </div>
        </div>
